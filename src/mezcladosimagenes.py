...
def page6():
    modelo ="Mezcla dos Imágenes"
    descripcion="Genera una nueva imágen a partir de dos imágenes seleccionadas"
    st.write(head(modelo, descripcion))
    #st.markdown("##Mezcla dos imágenes seleccionadas mediante instrucción de texto")
